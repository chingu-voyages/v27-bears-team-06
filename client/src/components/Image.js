    ...
    return (
        <div>
            <div className="lg:2/6 xl:w-2/4 mt-4 lg:mt-40 lg:ml-16 text-left flex flex-col items-center">
                ...
                <div className="mt-12 lg:mt-32 lg:ml-20 text-left flex flex-col items-cente r">
                    <button
                        type="button"
...
{imageUrl && <img src={imageUrl} alt={imageAlt} />}  
 <div class="p-5">
 <h1 class="text-2xl font-bold text-green-800 py-2">URL</h1>
...
{imageUrl && <img src={imageUrl} alt={imageAlt} />}
<div className="p-5">
    <h1 className="text-2xl font-bold text-green-800 py-2">Bird Name</h1>
