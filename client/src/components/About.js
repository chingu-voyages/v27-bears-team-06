...
export default function About(props){
    return (    
      <main className="mt-16 w-full flex justify-center md:justify-end" id="about">
            <div className="max-w-4xl mx-4 ">
              {/* <h2 className="pb-1 md:bg-clip-padding text-5xl font-extrabold text-blue-500">How It Works</h2> */}
